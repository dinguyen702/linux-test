...
echo "This script works with the unmodified sdcard image from the"
echo "A10 PR reference design that can be found on rocketboards at"
echo "https://rocketboards.org/foswiki/Projects/Arria10SoCHardwareReferenceDesignThatDemostratesPartialReconfiguration#A_42Release_Contents_42"
echo
